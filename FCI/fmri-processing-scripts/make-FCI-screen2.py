...
# This is a macro for creating time files for the FCI runs for screen 2 only
...
questionstart =  np.array(datafile['Slide2OnsetTime'], dtype=float) #questionstart
questionend =  np.array(datafile['Slide3OnsetTime'], dtype=float) #questionend
...
physfile = open(outputfilename + "-Screen2-Physics.txt", "w")
nonphysfile = open(outputfilename + "-Screen2-NonPhysics.txt", "w")
