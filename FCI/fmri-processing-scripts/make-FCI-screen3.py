...
questionstart =  np.array(datafile['Slide3OnsetTime'], dtype=float) #questionstart
...
physfile = open(outputfilename + "-Screen3-Physics.txt", "w")
nonphysfile = open(outputfilename + "-Screen3-NonPhysics.txt", "w")
