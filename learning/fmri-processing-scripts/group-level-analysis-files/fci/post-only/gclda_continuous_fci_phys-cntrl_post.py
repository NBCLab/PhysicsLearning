...
# Files to decode
f_in = '/home/data/nbc/physics-learning/data/group-level/fci/fci-postOnly_phys-cntrl_c123456_vtrhes_p001_cthres_p05.gfeat/cope1.feat/stats/zstat1.nii.gz'

# Output filename
f_out = 'gclda_fci_postOnly_phys-cntrl.csv'
