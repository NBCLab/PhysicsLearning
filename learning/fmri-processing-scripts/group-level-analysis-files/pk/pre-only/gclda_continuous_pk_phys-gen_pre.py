...
file_to_decode = '/home/data/nbc/physics-learning/data/group-level/retr/retr-preOnly_phys-gen_c123456_vthresh_p001_cthresh_p05.gfeat/cope1.feat/stats/zstat1.nii.gz'
...
print(df.head(10))
df.to_csv('gclda_retr_preOnly_phys-gen.csv', index_label='Term')
