...
file_to_decode = '/home/data/nbc/physics-learning/data/group-level/reas/reas-postOnly_reas-cntrl_c123456_vthres_p001_cthres_p05.gfeat/cope1.feat/stats/zstat1.nii.gz'
...
print(df.head(10))
df.to_csv('gclda_reas_postOnly_reas-base.csv', index_label='Term')
